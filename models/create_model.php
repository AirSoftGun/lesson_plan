...
class Create_model extends Model {
	...
	private function create_plan_in_db() {
		$input_query = $this->pdo->prepare("INSERT INTO `plans` (`url`, `title`, `border_color`, `text_color`, `background`, `create_date`, `visits`, `last_visit`) 
											VALUES (:url_param, :title_param, :border_color_param, :text_color_param, :background_img_param, :current_time_param, '0', NULL)");
		...
		$input_query->bindValue(':current_time_param', $this->time);
